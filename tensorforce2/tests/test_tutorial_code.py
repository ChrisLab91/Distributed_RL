...
class TestTutorialCode(unittest.TestCase):
    ...
    def test_reinforceio_homepage(self):
        ...
        from tensorforce2.agents import TRPOAgent
    ...
    def test_blogpost_introduction(self):
        ...
        ### DQN agent example
        from tensorforce2.agents import DQNAgent
        ...
        from tensorforce2.core.networks import Layer
        ...
        from tensorforce2.core.networks import Network
    ...
    def test_blogpost_introduction_runner(self):
        from tensorforce2.environments.minimal_test import MinimalTest
        from tensorforce2.agents import DQNAgent
        from tensorforce2.execution import Runner
