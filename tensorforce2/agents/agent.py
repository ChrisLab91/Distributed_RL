...
from tensorforce2 import util, TensorForceError
from tensorforce2.core.preprocessing import Preprocessing
from tensorforce2.core.explorations import Exploration
import tensorforce2.agents
...
class Agent(object):
    ...
    def from_spec(spec, kwargs):
        ...
        agent = util.get_object(
            obj=spec,
            predefined_objects=tensorforce2.agents.agents,
            kwargs=kwargs
        )
